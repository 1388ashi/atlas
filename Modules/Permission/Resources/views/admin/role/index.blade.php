                        ...
                        <table id="example-2" class="table table-striped table-bordered text-nowrap text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{-- Edit--}}
                                        <a href="{{ route('admin.roles.edit', $role) }}" style="pointer-events: {{$role->name == 'super_admin' ?'none':null}}" class="btn btn-warning btn-sm text-white" data-toggle="tooltip" data-original-title="ویرایش"><i class="fa fa-pencil"></i></a>
                                        <button type="button" class="btn btn-danger btn-sm text-white" data-original-title="حذف"  onclick="confirmDelete('delete-{{ $role->id }}')" >
