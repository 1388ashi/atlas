                        ...
                        <table class="table table-striped table-bordered text-nowrap text-center">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-top">نام کاربری</th>
                            ...
                            @forelse($admins as $admin)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger btn-sm text-white" onclick="confirmDelete('delete-{{ $admin->id }}')"><i class="fa fa-trash-o"></i></button>
                                        @else
                                        <button class="btn btn-danger btn-sm text-white" disabled onclick="confirmDelete('delete-{{ $admin->id }}')"><i class="fa fa-trash-o"></i></button>
                                        @endif
